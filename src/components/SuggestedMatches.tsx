...
export default function SuggestedMatches() {
    ...
    const fetchData = async () => {
        try {
            ...
            console.error("Suggested matches fetch error:", err);
        }
    };
    ...
    return (
        <div className="grid grid-cols-2 gap-8 p-4">
            <div>
                ...
                {unassigned.length === 0 ? (
                    <div className="col-span-2 bg-green-100 text-green-800 text-center p-4 rounded shadow">
                        🎉 All done! Come back later to help match folks together!
                    </div>
                ) : (
                    unassigned.map((ind) => (
